                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            @elseif ($element->type == 'textarea')
                                                <textarea class="form-control" id="{{ $element->name }}"
                                                    name="{{ $element->name }}" rows="4"></textarea>
                                            ...
                                            <div class="col-md-6">
                                                @foreach (explode(',', $element->options) as $option)
                                                    <div class="form-check">
                                                        <input type="{{ $element->type }}" class="form-check-input"
                                                            id="{{ $element->name }}_{{ $loop->index }}"
                                                            name="{{ $element->name }}[]"
                                                            value="{{ $option }}">
                                                        <label class="form-check-label"
                                                            for="{{ $element->name }}_{{ $loop->index }}">{{ $option }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        @endif
